...
public class RecyclerviewViewRiderAvailabaleOrderAdapter extends RecyclerView.Adapter<RecyclerviewViewRiderAvailabaleOrderAdapter.MyViewHolder> {

    List<OrderInfoForRider> list;
    Context context;

    public RecyclerviewViewRiderAvailabaleOrderAdapter(List<OrderInfoForRider> list, Context context) {
        this.list = list;
    ...
    @NotNull
    @Override
    public RecyclerviewViewRiderAvailabaleOrderAdapter.MyViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.singleview_order_info, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull RecyclerviewViewRiderAvailabaleOrderAdapter.MyViewHolder holder, int position) {
